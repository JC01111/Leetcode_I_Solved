...
class Solution:
    def addTwoNumbers(self, l1: Optional[ListNode], l2: Optional[ListNode]) -> Optional[ListNode]:
        # Q: Return the sum of l1 and l2 in reversed order
        # S: Create a new ListNode with a var carry
        # Traverse l1 and l2, calculate the sum with carry, update carry
        # Check the leftover once l1 and l2 is done.
        # TC: O(max(n, m)), n is total nodes in l1, m is total nodes in l2, SC: O(max(n, m))
        dummy = head = ListNode()
        carry = 0
        while l1 and l2:
            ...
            # Update l1 and l2, head
            head = head.next
            l1 = l1.next
            l2 = l2.next
        # If l1 or l2 still valid
        while l1:
            val = l1.val + carry
            carry = val // 10
            val = val % 10
