...
Jul 16, 2026. [Time Taken 5m 56s]
```python
class Solution:
    def isAnagram(self, s: str, t: str) -> bool:
        # S: Form two hashmaps for s and t
        # Loop over s and check each c in t's hashmap has the same size or not
